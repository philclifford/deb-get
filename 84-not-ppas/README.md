...
The software below can be installed, updated and removed using  the 84-not-ppas repository on philclifford's extras branch of `deb-get`:

<!-- [[[cog
import subprocess
import cog

pretty_list = subprocess.check_output(["../deb-get", "prettylist", "84-not-ppas", "--include-unsupported" ], encoding="utf-8")
cog.out(pretty_list)
]]] -->
